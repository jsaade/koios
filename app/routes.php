...
Route::group(['prefix'=>'api/', 'before'=>'secure'], function()
{
	...
	Route::post('app/{app}/contact-forms/{contact_forms}/add-attachments/{contact_values}', 'ApiContactFormController@storeAttachements')->before('contactFormAppRelation');;
	//LeaderBoard
